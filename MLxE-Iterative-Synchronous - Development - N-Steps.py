...
args = {# SYSTEM Settings
        ...
        # MULTISTEP TD   
        "n_step":1, # How many steps ahead should we sum up returns 0 = TD(0)
        ...
        while episod_counter.value < max_episodes:
            ...
            while done == False and internal_step_counter <= internal_step_counter_limit:
                ...
                if done == True or internal_step_counter == internal_step_counter_limit:
                    ...
                    observations = observations[-np.minimum(observations.shape[0], experience_max_batch_size + n_step):]
                    ...
                    # N-STEP
                    if n_step > 1:
                        current_state_n_step = observations[:-n_step,:state_n]
                        next_state_n_step = observations[n_step:,state_n:]
                        observations = np.concatenate([current_state_n_step,next_state_n_step], axis = 1)
