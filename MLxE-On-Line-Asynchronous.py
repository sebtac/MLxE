...
def LMxE(worker,
    ...
    if worker == 0:
        ...
        common_network_main = Dense(common_layers_n[0], activation='relu',name="1M", kernel_initializer=initializer)(inputs_main)
        common_network_main = Dense(common_layers_n[1], activation='relu',name="2M", kernel_initializer=initializer)(common_network_main)
        common_network_main = Dense(common_layers_n[2], activation='relu',name="3M", kernel_initializer=initializer)(common_network_main)

        policy_network_main = Dense(policy_layers_n[0], activation='relu',name="4M", kernel_initializer=initializer)(common_network_main)
        policy_network_main = Dense(policy_layers_n[1], activation='relu',name="5M", kernel_initializer=initializer)(policy_network_main)
        policy_network_main = Dense(policy_layers_n[2], activation='relu',name="6M", kernel_initializer=initializer)(policy_network_main)
        
        value_network_main = Dense(value_layers_n[0], activation='relu',name="7M", kernel_initializer=initializer)(common_network_main)
        value_network_main = Dense(value_layers_n[1], activation='relu',name="8M", kernel_initializer=initializer)(value_network_main)
        value_network_main = Dense(value_layers_n[2], activation='relu',name="9M", kernel_initializer=initializer)(value_network_main)

        logits_main = Dense(action_n,name="10M", kernel_initializer=initializer)(policy_network_main)
        values_main = Dense(1,name="11M", kernel_initializer=initializer)(value_network_main)
