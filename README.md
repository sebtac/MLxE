...
The ISTB Architecure resulted in significant improvement of the traing process and the agent gaint gaide an ability to play the game for 50K steps after exploring just 350 games. When left learing till 500 games the agent was returinig to the 50K steps level many times with ever higher freqency as the leraning continued. The below chart shows the comparison of the two runs: 
