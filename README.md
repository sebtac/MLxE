...
M Process(s) - the Memorizer(s): Manages the Experience Buffer (Memory) of the Learning Agent. It collects examples generated by Executors, processes them and batches them for consumption by the Learner

L Process(s) - the Learner(s): The core process of the Learning Agent responsible for updating model weights through (usually) an SGD based algorithm. It consumes the training examples generated by Memorizer and distributes updated models to Executors for generation of new examples.
